...
/**
 * @func pickProps - 遍历相关部件的 props, (我们不应把 element 的 props 部传入每个部件， 只需要传对应需要的 props!)
...
class FormBuilder extends Component {
  ...
  renderElement = (element, index) => {
    ...
    if (
      meta.elements &&
      this.props.children &&
      getLastIndex(this.props.dynamic, meta.elements) === index
    ) {
